...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --hue2: 335;
            /* HSL color mode */
            --base-color: hsl(var(--hue) 89% 44%);
            --base-color-second: hsl(var(--hue) 95% 32%);
            --base-color-alt: hsl(var(--hue2) 45% 32%);
            --title-color: hsl(var(--hue) 88% 57%);
    ...
    <style>
        ...
        /*.header-sticky.sticky-bar {background: #bd3034;}*/
        li {
            list-style: none;
        }
    ...
    <?php } ?>
        ...
        <header>
                                                ...
                                                <ul class="nav-main-top mg-left" style="width: 57%; margin-left: 11%; margin-right: -6%;">
                                                    <li class="text-center" style="width: 100%;position: relative;top: 23%;">
                                                        <form id="buscador" action="<?php echo base_url('servico/buscaServicos'); ?>" method="post">
                                                            <input style="font-weight: 500;height: 28px;height: 35px;" name="busca" id="search_produto" type="text" class="form-control" placeholder="Pesquise por aqui" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                            <a class="btn btn-primary lupa-bt" style="position: relative;top: -35px;left: 46.5%;height: 35px;background-color: #ec9706;border-color: #ec9706;" onclick="searchTrigger()"><i style="cursor: pointer;color: #bd3034;font-size: 25px;" class="fa fa-search" aria-hidden="true"></i></a>
                                                        </form>
                                                    </li>
                                                </ul>
                                                    ...
                                                    <span style="font-size: 15px; padding-left: 5px">Login</span>
                                                        ...
                                                        <li class="menu-li" style="position: relative;top: 20px;left: 80px; margin-left: 30px;">
                                                            <span class="menu-a" href="#">
                                                                <span style="font-size: 15px;"><i style="font-size: 30px; color: #ec9706;" class="fa fa-user-circle"></i><span>&nbsp Faça <a style="font-weight: 500; color:white;" href="<?php echo base_url('2b1e190210df261675c4b801bc6e8989') ?>">Login</a> ou <br>
            ...
            <?php if ($mobile_view == 1) { ?>
                <div class="header-area header-transparent pt-20 menu-transparente" tyle="z-index:99; position:fixed; width:100%; background: -webkit-linear-gradient(bottom, #082b3d, #bd3034);">
                    <!-- background: -webkit-linear-gradient(bottom, #082b3d, #bd3034, #361c25, #4c201c); box-shadow: rgb(0 0 0 / 15%) 1.95px 1.95px 2.6px; -->
                    <div class="header-sticky main-header" <?php if (!$mobile_view) { ?>style="height: 100%; padding: 10px 30px;" <?php } ?>>

                        <div class="container-fluid" style="">
                            <!--background: -webkit-linear-gradient(bottom, #082b3d, #bd3034, #4c1d1c, #4e3721);-->
                            <div class="align-items-center row">
                                <div class="col-12">
            ...
            <!-- Navbar Area -->
            <?php if ($mobile_view == 0) { ?>
                <nav class="navbar navbar-expand-lg" id="mobile" style="position: fixed; top: 80px; z-index: 98; width: 100%; background: #bd3034; ">
