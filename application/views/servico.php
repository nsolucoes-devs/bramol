    ...
    <section class="contact-section" style="margin-bottom: 5%;">
        <div class="container row-eq-height" style="margin-top: 10%">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 p-0">
                                    <div class="row justify-content-center">
                                        <div class="col-md-6 col-6 align-items-center col-6 col-md-6 d-flex flex-column">
                                            <?php if ($servico['valor_desconto']) { ?>
                                                ...
                                                <h3 class="preco-principal m-0" style="color: #444; text-align: center; font-size: 30px; ">R$ <?php echo number_format($servico['valor_desconto'], 2, ',', '.') ?></h3>
                                                <p class="preco-parcela" style="text-align: center; font-weight: bold; margin-top: -2%; margin-left: -7%;"><?= $servico['servico_qtd_parcela'] ?></p>
                                            <?php } else { ?>
                                                <h3 class="preco-principal m-0" style="color: #444; font-size: 30px;">R$ <?php echo number_format($servico['servico_valor'], 2, ',', '.') ?></h3>
                                                <p class="preco-parcela" style="text-align: center; font-weight: bold; margin-top: -2%; margin-left: -7%;"><?= $servico['servico_qtd_parcela'] ?></p>
                                            <?php } ?>
                                        </div>
                                        <?php if ($estoque != 0) { ?>
            ...
            <div class="row" style="background: white;">
                <div class="col-md-12 text-left form-group m-0" style="margin-top: -3%; padding-left: 4%">
