...
<section class="features-area section-padding-100-0" style="height: 100%; margin-bottom: -15%;">
    ...
    <?php if ($mobile_view == 1) { ?>
        ...
        <div class="col-lg-12 col-md-12">
                    ...
                    <div class="row">
                        ...
                        ?>
                                ...
                                <div class="col-6 col-md-4 col-xs-6 col-sm-4 col-lg-3 mb-4">
                                    <div class="card zoom card-relacionados" style="border-radius: 7px; height: 100%;">
                                        <div class="card-body p-2 pb-0" style="border-bottom: 7px solid #EC9706; border-radius: 7px;">
                                            <a href="<?php echo base_url('e9b8ed001f1726b0385dcfec2dbe2ea1/') . $p['servico_id'] ?>">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 text-center">
                                                        <p class="text-center stars" style="font-size: 12px; margin: 4%;">
                                                        ...
                                                        <p class="text-center" style="margin-top: 7%; font-weight: 600; color: #0b193c;"><?php echo ucfirst(mb_strtolower($p['servico_nome'])) ?></p>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <?php } else { ?>
                                                                <div class="col-12 col-md-12 text-center mt-4" style="margin-top: -1rem!important;">
        ...
        <?php if ($mobile_view == 0) { ?>
            ...
            <!-- Desktop -->
            <div class="row margin-ipad my-5" style="margin: -8%; padding: 6%;">
            <div class="col-lg-12 col-md-12">
                    <div class="row form-group">
                        <div class="col-xl-12">
                            <p class="pPesquisa">Resultado da Pesquisa</p>
